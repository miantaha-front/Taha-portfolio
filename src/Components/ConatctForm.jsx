  ...
  return (
    <section className="contact-section-bg py-5" id="contacts">
      <Container className="d-flex justify-content-center align-items-center min-vh-100">
        ...
        {/* ⚡ YAHAN BORDER WRAPPER ADD KIYA HAI */}
        <div className="contact-animated-border-box">
          <div className="contact-neon-spinner"></div>
          
          {/* Main Floating Card - NO CHANGES HERE */}
          <div className="contact-main-wrapper shadow-lg d-flex flex-column flex-md-row">
            ...
            <div className="contact-left-visual d-flex flex-column justify-content-end p-4">
              ...
              <img src={process.env.PUBLIC_URL + "/myimg2.jpeg"} alt="Profile" className="side-bg-img" />
            </div>
        ...
        </div> {/* ⚡ CLOSING DIV FOR THE BORDER */}
